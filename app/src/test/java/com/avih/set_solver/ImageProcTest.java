...
public class ImageProcTest {
    ...
    public void testExtractCard_1()
    {
        ...
        int IMAGE_NUM = 1;
        Mat src = imread(TEST_IMAGE_PATH_BASE + IMAGE_NUM +  ".jpg");
        ...
        {
            boolean isCardValue = imageProcessor.isCard(cardContours.get(i));
            if (isCardValue) {
                Mat card = unWarpCard(src, cardContours, i);
                imwrite(OUTPUT_PATH + "img" + IMAGE_NUM + "_card_" + i + ".jpg", card);
            }
        }
    }
